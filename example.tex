...
Zu beachten ist, dass \gls{slam} auf die \textquote{originale Definition} aus \inlinelisp{(foo bar)} zu beziehen ist. It runs \cite{patrick_rothfuss_name_2012} in \( \forall n \in \mathbb{N}: \mathcal{O}(\log n^2) \) foobar \cite{patrick_rothfuss_furcht_2011} baaaaar \cite{patrick_rothfuss_furcht_2012}
